function! iceberg#palette#light#create() abort
  ...
  let g.green  = pgmnt#color#hsl(hue_green,  0.45, 0.40)
  ...
  let g.red    = pgmnt#color#hsl(hue_red,    0.55, 0.60)
  ...
  " statusline
  let g.statusline_bg = pgmnt#color#hsl(hue_base, 0.20, 0.75)
  let g.statusline_fg = pgmnt#color#hsl(hue_base, 0.20, 0.35)
